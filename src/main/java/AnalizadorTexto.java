 ...
 */
public final class AnalizadorTexto extends StopwordAnalyzerBase {
     ...
     */
    public AnalizadorTexto(CharArraySet stopwords) {
     ...
     */
    public AnalizadorTexto(CharArraySet stopwords, CharArraySet stemExclusionSet) {
        super(stopwords);
